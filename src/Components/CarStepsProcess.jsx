...
function CarStepsProcess() {
  return (
    <div>
       <div className="container-fluid steps py-5">
            <div className="container py-5">
                <div className="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style={{maxWidth: "800px;"}}>
                    <h1 className="display-5 text-capitalize text-white mb-3">Sahosoft<span className="text-primary"> Process</span></h1>
...
export default CarStepsProcess
